...
vim.api.nvim_set_keymap(
  'n', '<leader>c', ':lclose|cclose|helpclose<cr>', {noremap = true}
)
vim.api.nvim_set_keymap('n', '<leader>d', ':bd<cr>', {noremap = true})
vim.api.nvim_set_keymap(
  'n', '<leader>f', ':echo expand("%:p")<cr>', {noremap = true}
)
...
vim.api.nvim_set_keymap(
  'n', '<leader><esc>', ':setlocal nohlsearch<cr>',
...
vim.api.nvim_set_keymap(
  'n', '<c-j>', ':move .+1<cr>', {noremap = true, silent = true}
)
vim.api.nvim_set_keymap(
  'n', '<c-k>', ':move .-2<cr>', {noremap = true, silent = true}
)
vim.api.nvim_set_keymap(
  'v', '<c-j>', ':move \'>+1\'<cr>gv=gv', {noremap = true, silent = true}
)
vim.api.nvim_set_keymap(
  'v', '<c-k>', ':move \'<-2\'<cr>gv=gv', {noremap = true, silent = true}
)
