...
if Grid then
  ...
  hs.hotkey.bind(
    leadershift, 'h', function()
      hs.grid.resizeWindowThinner()
    end
  )
  hs.hotkey.bind(
    leadershift, 'l', function()
      hs.grid.resizeWindowWider()
    end
  )
  hs.hotkey.bind(
    leadershift, 'k', function()
      hs.grid.resizeWindowShorter()
    end
  )
  hs.hotkey.bind(
    leadershift, 'j', function()
